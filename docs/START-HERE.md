...
something else"* works fine — if it's unclear, it'll ask.

You can also just ask questions: *"what does my pricing section say right now?"*,
*"does anything still say $400?"*, *"what changed this week?"*
...
## Two things already broken (not your fault)

**Your contact form doesn't send you anything.** Parents who fill it out see a
"Got it! I'll get back to you within 24 hours" message, but it never reaches you.
Inquiries are being lost right now. The email address underneath the form does
work. **This is the highest-value thing to have Robbi fix.**

**Your real domain isn't set up.** The site says
`hello@jessicaslearninglounge.com`, but that address doesn't go anywhere yet.
Also Robbi's job.
